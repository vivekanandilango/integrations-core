...
DEFAULT_METRICS = {
    ...
    'autoscaling_autoscaler_conditions': 'autoscaling.autoscaler_conditions',
    'autoscaling_horizontal_scaling_applied_replicas': 'autoscaling.horizontal_scaling_applied_replicas',
    'autoscaling_horizontal_scaling_attempts': 'autoscaling.horizontal_scaling_attempts',
    'autoscaling_horizontal_scaling_errors': 'autoscaling.horizontal_scaling_errors',
    'autoscaling_horizontal_scaling_received_replicas': 'autoscaling.horizontal_scaling_received_replicas',
    ...
    'autoscaling_rollout_triggered': 'autoscaling.rollout_triggered',
    'autoscaling_status_condition': 'autoscaling.status_condition',
    'autoscaling_vertical_scaling_applied_limits': 'autoscaling.vertical_scaling_applied_limits',
    'autoscaling_vertical_scaling_applied_requests': 'autoscaling.vertical_scaling_applied_requests',
    'autoscaling_vertical_scaling_attempts': 'autoscaling.vertical_scaling_attempts',
    'autoscaling_vertical_scaling_errors': 'autoscaling.vertical_scaling_errors',
    'autoscaling_vertical_scaling_received_limits': 'autoscaling.vertical_scaling_received_limits',
    'autoscaling_vertical_scaling_received_requests': 'autoscaling.vertical_scaling_received_requests',
